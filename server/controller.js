...
module.exports = {
    ...
    getAllClients: (req, res) => {
        sequelize.query(`select * from cc_clients as client
        join cc_users u on client.user_id = u.user_id;`)
            .then(dbRes => res.status(200).send(dbRes[0]))
    },
    ...
    getPastAppointments: (req, res) => {
        sequelize.query(`select a.appt_id, a.service_type, a.notes, a.date, u.first_name, u.last_name
